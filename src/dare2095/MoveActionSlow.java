 ...
 * @author amy
 */
public class MoveActionSlow extends AbstractAction {
	/**
	 * If the acceleration is less than this number, the target is assumed to be reached
	 */
	public static double TARGET_REACHED_ACCEL = 4;//0.0001

	/**
	 * allowable error in the target error before you say it is there
	 */
	public static double TARGET_REACHED_ERROR = 4.0;//2.0;
	 ...
	 */
	public MoveActionSlow(Toroidal2DPhysics space, Position currentLocation, 
