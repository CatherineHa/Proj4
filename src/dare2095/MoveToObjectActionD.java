 ...
 * @author amy
 */
public class MoveToObjectActionD extends MoveActionD {
	 ...
	 * @param goalObject
	 */
	public MoveToObjectActionD(Toroidal2DPhysics space, Position currentLocation, AbstractObject goalObject) {
		super(space, currentLocation, goalObject.getPosition(), goalObject);
